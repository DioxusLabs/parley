...
use crate::{AlignmentBaseline, BaselineShift, FontContext, InlineBox, LineHeight, VerticalAlign};
...
pub(crate) fn resolve_style_metrics<B: Brush>(
    ...
    let (mut query, cache) = fcx.query_and_cache();
    ...
    for (index, style) in styles.iter().enumerate() {
        ...
        let font_metrics = match cached {
            ...
            None => {
                ...
                let attributes = fontique::Attributes {
