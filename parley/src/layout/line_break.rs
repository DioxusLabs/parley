...
impl LineBoxMetrics {
    ...
    ///
    /// This adds the style's inline box together with its ancestors, and the run's box if it has
...
/// otherwise the style's inline box alone sizes the line and this returns `None`.
///
