...
- A run's `line_height` was taken from the style of the *following* run when the style changed at a run boundary, and a change in `line_height` alone did not start a new run.
